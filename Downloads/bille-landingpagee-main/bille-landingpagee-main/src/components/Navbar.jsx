        ...
        <div className="flex items-center space-x-3">
          <Link to="/" aria-label="Go to home" className="flex items-center">
            <img
              ...
              alt="BALLIE logo"
              className="h-12 w-auto object-contain md:h-14 lg:h-16 ml-3 transition-all duration-300"
            />
          </Link>

          {/* Top bar sections: visible on md+ */}
          <div className="hidden md:inline-flex items-center rounded-full bg-[#2a2425] p-1">
            <NavLink
              to="/"
              end
              className={({ isActive }) =>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `ml-1 px-3 py-1 rounded-full text-sm transition ${
                  isActive
                    ? "bg-accent text-black font-semibold"
                    : "text-gray-200 hover:text-accent"
                }`

...
const UserBenefits = () => {
  ...
  return (
    <section className="relative mx-auto mt-16 w-full max-w-7xl overflow-hidden rounded-[28px] bg-black px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20 text-white">
      {/* top-right lime stripes */}
      <div className="pointer-events-none absolute right-6 sm:right-10 top-6 flex gap-2">
        <span className="h-2 w-10  rounded-sm bg-lime-400 rotate-90" />
        <span className="h-8 w-[10rem]  rounded-sm bg-lime-400 " />
      </div>
      ...
      <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-2">
        ...
        <div className="relative flex items-end justify-center md:justify-start">
          ...
          <div
            ...
            style={{
              borderRadius: "9999px",
              background: "radial-gradient(closest-side, #a6f22a 70%, transparent)",
        ...
        <div className="flex flex-col items-center md:items-end">
          <div className="w-full md:max-w-[520px] lg:max-w-[560px] text-center md:text-right">
            ...
            <p className="mx-auto md:mx-0 text-gray-300 text-sm sm:text-[15px]">
              ...
              vel ullamcorper sed aliquet. Lacus habitant tortor pulvinar pellentesque.
              Donec sed scelerisque nisi ut urna sagittis turpis posuere. Iaculis
              elementum netus duis ullamcorper eu semper egestas augue. Pretium
              dictumst donec morbi velit risus.
            </p>
          </div>
